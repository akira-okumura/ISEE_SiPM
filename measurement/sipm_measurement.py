...
import PSupply
import FGenerator
import FGenerator_target
import readout
# import OScope_tek as OScope
import PSoff
import takedata_fun as takedata
...
##  gsc02.initializeOrigin(1,0) #imitate power off
  ...
  time.sleep(1)
  print("Reading SiPM")
  takedata.takedata("sipm_nocoating/3500_500_4_%ddeg_fwd.fits" % (angles[i]), 40000, target_runid, 900)
  target_runid = 1
...
##  gsc02.initializeOrigin(1,0) #imitate power off
  ...
  time.sleep(1)
  print("Reading PMT")
  readout.readout(angles[i],50,"sipm_nocoating/monitor_bwd")
  time.sleep(1)
  print("\nSetting up the FG:")
  time.sleep(1)
  FGenerator_target.initialize(wavelength)
  time.sleep(1)
  print("Reading SiPM")
  takedata.takedata("sipm_nocoating/3500_500_4_%ddeg_bwd.fits" % (angles[i]), 40000, target_runid, 900)
  target_runid = 1
  print("Finished reading")
  print("Stage power on")
  time.sleep(1)
