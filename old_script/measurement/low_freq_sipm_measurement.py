...
##  gsc02.initializeOrigin(1,0) #imitate power off
  ...
  time.sleep(1)
  print("Reading SiPM")
  takedata.takedata("sipm_nocoating/2500_0_4_%ddeg_fwd.fits" % (angles[i]), 40000, target_runid, 900)
  target_runid = 1
...
#   time.sleep(1)
#   print("Reading SiPM")
#   takedata.takedata("sipm_nocoating/4400_0_6_%ddeg_bwd.fits" % (angles[i]), 40000, target_runid, 900)
#   target_runid = 1
#   print("Finished reading")
#   print("Stage power on")
#   time.sleep(1)
